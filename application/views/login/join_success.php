<div class="ui stackable grid container">
	...
	<div class="row">
		...
		<div class="eight wide column centered">
            ...
            <a href="<?=base_url('/login')?>" class="fluid ui teal button">立即登入</a>
                <div class="ui relaxed divided list">
                    <div class="item">
                        <i class="large comment middle aligned icon"></i>
                        <div class="content">
                            <a class="header">我收不到信</a>
                            <div class="description">請先檢查垃圾信件，且每個信箱收到的時間也有所差異。</div>
                        </div>
                    </div>
                    <div class="item">
                        <i class="large comment middle aligned icon"></i>
                    ...
                    <div class="item">
                        ...
                        <div class="content">
                            ...
                            <div class="description">請點選 "忘記密碼" 並填寫申請時的信箱，再去信箱收確認信即可。</div>
                        </div>
                    </div>
                </div>
			</div> <!-- END OF SEGMENT-->
