...
<head>
	...
	<meta property="og:image" content="https://i.imgur.com/A2jHyZI.png">
	...
	<link href="<?=base_url()?>assets/messenger.css" rel="stylesheet" media="screen">
	<link href="<?=base_url()?>assets/messenger-theme-flat.css" rel="stylesheet" media="screen">
	...
	<script src="<?=base_url()?>assets/messenger.min.js"></script>
	<script src="<?=base_url()?>assets/messenger-theme-flat.js"></script>
